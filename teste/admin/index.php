        ...
        if(isset($_POST['user']) && isset($_POST['pass'])) {
          ...
          if($query->num_rows > 0) {
            if($data['estado'] == "0") {
              ...
              header('Location: '.$arrConfig['url_admin'].'/cliente/index.php?user='.$_POST['user']);
              mysqli_close($conn);
            }
          } else {
...
<div class ="caixa">
    <form method="post" action="index.php">
      <img class="imagem" src="img/admin.png" width=80px; alt="">
      
      <input class ="campos" type="text" name="user" placeholder="Introduza o seu Username"> <br>
      <input class ="campos" type="password" name="pass" placeholder="Introduza a sua senha">

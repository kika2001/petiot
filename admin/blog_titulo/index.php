...
<body>
			...
			foreach($arrcampos['campos'] as $k => $v) {
				if($v['listar'] == 1) 
					if (($k == 'estado')&&($value['estado']==1)) {
						echo '<td>'.'<img src="../contactos/icons/ativo.png" width="42" height="42" '."/>".'</td>';
					}else{
						if (($k == 'estado')&&($value['estado']==0)) {
							echo '<td>'.'<img src="../contactos/icons/inativo.png" width="42" height="42"'."/>".'</td>';
						}else{
	...
	<table border ="1">
		<td>
		<a href="../index.php"><img src="../contactos/icons/back.png" width="42" height="42"</a>	
		<td>
		<a href="inserir.php"><img src="../contactos/icons/inserir.png" width="42" height="42"</a>
		</td>
		</td>
	</table>
</body>

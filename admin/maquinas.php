...
<body>
	...
	?>
     ...
     <form  method="post" >
	  ...
	  <input type="number" name="intervalo" min="1" max="100" style="width: 3em" value="<?php echo $intervalo ?>">
	  <span class="error"><font color="red">* <?php echo $intervaloErr;?></font></span><br>
	  Quantidade de Comida:<br>
	  <input type="number"  name="quantidade" min="1" max="10" style="width: 3em" value="<?php echo $quantidade ?>">
